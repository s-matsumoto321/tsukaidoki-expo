...
export const PROJECTS: Record<string, Project> = {
  ...
  edu: {
    ...
    actuals: {
      0: { date:'2025/4', name:'積立開始 確認', detail:'¥30,000/月 配分スタート・残高確認', amt:'+¥30,000/月', pos:true, dot:'#0C447C' },
      2: null, // 未入力
    },
  },
  ret: {
    ...
    actuals: {
      0: { date:'2025/4', name:'積立開始 確認', detail:'¥50,000/月 配分スタート・残高確認', amt:'+¥50,000/月', pos:true, dot:'#0C447C' },
    },
  },
  car: {
    id: 'car', kind: 'project',
    ...
    actuals: {
      0: { date:'2025/4', name:'積立開始 確認', detail:'¥40,000/月 配分スタート・残高確認', amt:'+¥40,000/月', pos:true, dot:'#0C447C' },
      3: null, // 未入力（2028年のため未到達）
    },
  },
  trip: {
    id: 'trip', kind: 'project',
    name: '旅行資金', timing: '年1回国内旅行・2031年TDL・2037年豪州',
    now: 500_000, goalLabel: '旅行コース充実', statusTxt: '順調', color: '#EF9F27',
    ...
    events: [
      {idx:0, type:'start', dot:'#0C447C', year:'2025', name:'積立スタート', detail:'月¥30,000 配分中', amt:'+¥30,000/月', pos:true},
      {idx:1, type:'spend', dot:'#E24B4A', year:'2026', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:2, type:'spend', dot:'#E24B4A', year:'2027', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:3, type:'spend', dot:'#E24B4A', year:'2028', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:4, type:'spend', dot:'#E24B4A', year:'2029', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:5, type:'spend', dot:'#E24B4A', year:'2030', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:6, type:'spend', dot:'#E24B4A', year:'2031', name:'東京ディズニーランド旅行', detail:'家族4人・2泊3日', amt:'-¥300,000', pos:false},
      {idx:7, type:'spend', dot:'#E24B4A', year:'2032', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:8, type:'spend', dot:'#E24B4A', year:'2033', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:9, type:'spend', dot:'#E24B4A', year:'2034', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:10, type:'spend', dot:'#E24B4A', year:'2035', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:11, type:'spend', dot:'#E24B4A', year:'2036', name:'国内旅行', detail:'年1回の国内家族旅行', amt:'-¥150,000', pos:false},
      {idx:12, type:'spend', dot:'#E24B4A', year:'2037', name:'オーストラリア旅行', detail:'家族4人・10日間 シドニー・ゴールドコースト', amt:'-¥800,000', pos:false},
    ],
    actuals: {
      0: { date:'2025/4', name:'積立開始 確認', detail:'¥30,000/月 配分スタート', amt:'+¥30,000/月', pos:true, dot:'#0C447C' },
    },
  },
  ...
  'pool-shoken': {
    ...
    now: 3_000_000, goalLabel: '運用残高', statusTxt: '運用中', color: '#0C447C',
    ...
    events: [
      {idx:0,type:'start',dot:'#0C447C',year:'2024/4',name:'積立・運用開始',detail:'月¥50,000 積立設定',amt:'+¥50,000/月',pos:true},
      {idx:2,type:'in',dot:'#1D9E75',year:'2024/10',name:'配当金・分配金入金',detail:'投資信託の分配金',amt:'+¥24,000',pos:true},
      {idx:4,type:'in',dot:'#EF9F27',year:'2025/4',name:'追加入金・リバランス',detail:'株式比率を調整',amt:'+¥100,000',pos:true},
    ],
    actuals: {
      0: { date:'2024/4', name:'積立設定 完了', detail:'¥50,000/月 自動積立スタート', amt:'+¥50,000/月', pos:true, dot:'#0C447C' },
      2: { date:'2024/10', name:'配当金 入金', detail:'実績 ¥21,000（計画¥24,000より少）', amt:'+¥21,000', pos:true, dot:'#1D9E75' },
      4: null, // 未入力
    },
  },
  'pool-teiki': {
    ...
    now: 2_500_000, goalLabel: '預入残高', statusTxt: '自動更新中', color: '#185FA5',
    ...
    events: [
      {idx:0,type:'start',dot:'#0C447C',year:'2023',name:'1年定期 預け入れ',detail:'金利 年0.2%',amt:'¥2,500,000 預け入れ',pos:true},
    ...
    actuals: {
      0: { date:'2023/1', name:'定期預金 預入 完了', detail:'¥2,500,000 · 金利0.2%確認', amt:'¥2,500,000', pos:true, dot:'#0C447C' },
      1: { date:'2024/1', name:'満期・自動更新 確認', detail:'利息¥5,000 入金確認済み', amt:'+¥5,000', pos:true, dot:'#1D9E75' },
      2: null, // 未入力
    },
  },
  'pool-nisa': {
    ...
    now: 1_000_000, goalLabel: '評価残高', statusTxt: '積立中', color: '#378ADD',
    ...
    events: [
      {idx:0,type:'start',dot:'#0C447C',year:'2023/1',name:'積立NISA 開始',detail:'月¥33,000 積立設定',amt:'+¥33,000/月',pos:true},
      {idx:2,type:'in',dot:'#1D9E75',year:'2024/1',name:'新NISA 制度移行',detail:'年間投資枠が最大360万円に拡大',amt:'枠拡大',pos:true},
      {idx:4,type:'in',dot:'#EF9F27',year:'2025/1',name:'含み益 初めてプラスへ',detail:'評価損益 +¥42,000',amt:'+¥42,000 評価益',pos:true},
    ],
    actuals: {
      0: { date:'2023/1', name:'積立設定 完了', detail:'¥33,000/月 自動積立スタート', amt:'+¥33,000/月', pos:true, dot:'#0C447C' },
      2: { date:'2024/1', name:'新NISA 移行 確認', detail:'旧NISA→新NISA 自動移行完了', amt:'枠拡大', pos:true, dot:'#1D9E75' },
      4: null, // 未入力
    },
  },
  'pool-main': {
    ...
    now: 800_000, goalLabel: '現在残高', statusTxt: '安定', color: '#85B7EB',
    ...
    events: [
      {idx:0,type:'start',dot:'#0C447C',year:'2025/4',name:'給与振込・家賃引き落とし',detail:'毎月の収支サイクル',amt:'+¥280,000 / -¥95,000',pos:true},
      {idx:2,type:'spend',dot:'#E24B4A',year:'2025/8',name:'車保険 年払い引き落とし',detail:'自動車保険 一括払い',amt:'-¥68,000',pos:false},
      {idx:3,type:'in',dot:'#1D9E75',year:'2025/10',name:'夏ボーナス振込',detail:'余剰分を証券口座へ移動',amt:'+¥800,000',pos:true},
    ],
    actuals: {
      0: { date:'2025/4', name:'給与振込 確認', detail:'振込¥280,000 · 家賃¥95,000引き落とし', amt:'+¥185,000', pos:true, dot:'#0C447C' },
      2: { date:'2025/8', name:'車保険 引き落とし', detail:'実績 ¥68,000（計画通り）', amt:'-¥68,000', pos:false, dot:'#E24B4A' },
      3: null, // 未入力
    },
  },
  'pool-sub': {
    ...
    now: 450_000, goalLabel: '現在残高', statusTxt: '安定', color: '#B5D4F4',
    ai: '生活費口座として適切な残高水準です。冷蔵庫購入で一時減少しましたが翌月回復しています。',
    years: ['4月','6月','8月','10月','12月','2月'],
    plan:   [45, 47, 44, 47, 45, 43],
    actual: [45, 48, 43, 46, 45,null],
    events: [
      {idx:0,type:'start',dot:'#0C447C',year:'2025/4',name:'生活費口座として運用開始',detail:'メイン口座より月¥100,000 振替',amt:'+¥100,000/月',pos:true},
      {idx:1,type:'in',dot:'#1D9E75',year:'2025/6',name:'水道光熱費 口座振替',detail:'電気・ガス・水道 計¥22,000',amt:'-¥22,000/月',pos:false},
      {idx:3,type:'spend',dot:'#E24B4A',year:'2025/10',name:'家電購入（冷蔵庫）',detail:'突発的な家電買い替え',amt:'-¥120,000',pos:false},
    ],
    actuals: {
      0: { date:'2025/4', name:'振替設定 完了', detail:'メイン→サブ ¥100,000/月 設定', amt:'+¥100,000/月', pos:true, dot:'#0C447C' },
      1: { date:'2025/6', name:'光熱費 引き落とし', detail:'実績 ¥24,000（計画¥22,000より少し多め）', amt:'-¥24,000', pos:false, dot:'#1D9E75' },
      3: null, // 未入力
    },
  },
};
